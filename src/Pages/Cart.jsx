...
const Cart = () => {
  ...
  return (
    ...
    <div>
      { cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center mb-12">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div className="flex flex-col">
              <p className="text-xl font-bold"><span className="text-gray-700 font-semibold">Total Amount:</span> ${total}</p>
